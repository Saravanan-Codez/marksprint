...
export class WebGLManager {
  ...
  constructor(props, paletteTex, bgVec4, refs) {
    this.props = props;
    this.isVisibleRef = refs.isVisibleRef;
    this.rafRef = refs.rafRef;
    this.resizeRafRef = refs.resizeRafRef;
  ...
  init(paletteTex, bgVec4) {
    ...
    this.output = new Output(paletteTex, bgVec4, this.Common, this.Mouse);
  }
